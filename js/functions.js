...
document.addEventListener("DOMContentLoaded", function() {
  ...
  scrollLinks.forEach(function(link) {
      link.addEventListener("click", function(event) {
          // Prevenir el comportamiento predeterminado de hacer clic en el enlace
          event.preventDefault();
          
          // Obtener el destino del desplazamiento a partir del atributo "href" del enlace
          var targetId = link.getAttribute("href");
          var targetElement = document.querySelector(targetId);
          
          // Verificar si el elemento de destino existe en la página
          if (targetElement) {
              // Calcular la posición de desplazamiento objetivo
              var targetOffsetTop = targetElement.offsetTop;
              
              // Desplazarse suavemente a la posición de destino con una animación
              window.scrollTo({
                  top: targetOffsetTop,
                  behavior: "smooth"
              });
